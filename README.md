...
- [En la carpeta **node05**](https://github.com/eugenia1984/codo-a-codo-back-end-node/tree/main/node05/README.md) podras ver la teoría sobre base de datos, con MySQL: crear base de datos, crear tablas, PK, FR, insertar registros.
